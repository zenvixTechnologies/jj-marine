            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <select className="w-full bg-white/70 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-marine-secondary focus:border-marine-secondary transition-all outline-none appearance-none">
                      <option>Deck Officer</option>
                      <option>Marine Engineer</option>
                      <option>Logistics Coordinator</option>
                      <option>Fleet Manager</option>
                      <option>HSE Supervisor</option>
                    </select>
                ...
                <div className="flex flex-wrap gap-4">
                  {["1-3 Years", "4-7 Years", "8+ Years"].map((label, idx) => (
                    <label key={idx} className="flex-1 min-w-[100px] cursor-pointer">
                      <input className="hidden peer" name="exp" type="radio" defaultChecked={idx === 0} />
              ...
              <div className="space-y-2">
                ...
                <div className="group relative flex flex-col items-center justify-center p-10 border-2 border-dashed border-gray-200 rounded-3xl hover:border-marine-gold transition-colors bg-white/30 cursor-pointer overflow-hidden text-center">
                  ...
                  <p className="text-marine-primary font-bold text-sm">Drag and drop file here</p>
